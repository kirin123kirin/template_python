...
try:
    from __PROJECT_NAME__ import *
    kw = {"setup": "from __PROJECT_NAME__ import *"} if PY2 else {}
except ImportError:
    from __PROJECT_NAME__.__PROJECT_NAME__ import *
    kw = {"setup": "from __PROJECT_NAME__.__PROJECT_NAME__ import *"} if PY2 else {}
...
def test___PROJECT_NAME__():
    assert(__PROJECT_NAME__("hello"))


def test___PROJECT_NAME___perf():
    runtimeit('pass')
